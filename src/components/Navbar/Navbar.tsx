          ...
          <Navbar collapseOnSelect expand="lg"  bg="transparent"  className="bg-light survey-nav">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <ul className="nav navbar-nav ml-auto">
                <li><Link to="/" className="navbar-element ">Home</Link></li>
                <li><Link to="/new" className="navbar-element ">New Coupon</Link></li>
                <li><Link to="/redeem" className="navbar-element ">Redeem Coupon</Link></li>
