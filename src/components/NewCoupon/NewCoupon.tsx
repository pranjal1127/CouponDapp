                ...
                switch (this.state.currentScreen) {
                      ...
                      <>
                        ...
                        >
                          <FormControl
                            ...
                            onChange={(e)=> this.setState({spinner0 : false, esAmount : e.target.value})}
                          />
                          <InputGroup.Append>
                            <Button
                              className="large"
                        ...
                        <Button
                          ...
                          onClick={async () => {
                            ...
                            const couponHash = ethers.utils.hexlify(couponBytes);
                            const signature = await window.wallet.signMessage(couponBytes);
                            const Encodevalue:string = ethers.utils.RLP.encode([couponHash,signature]);
                            this.setState({
                              currentScreen: 1,
                              couponBytes,
                              couponHash,
                  ...
                  case 1:
                    return (
                      <>
                        <h3>Step 2</h3>
                        Download the coupon QR code by clicking below button. This
